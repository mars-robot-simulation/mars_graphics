...
#include <osg_terrain/ShaderTerrain.hpp>
...
#error Unknown OSG Version OPENSCENEGRAPH_MAJOR_VERSION
        ...
        void TerrainDrawObject::collideSphere(Vector pos, sReal radius)
        {
            ...
            return;
#endif
            fprintf(stderr, "The collideSphere() function is not implemented for the default terrain visualization, set the use USE_VERTEX_BUFFER option in the mars_graphics/CMakeLists.txt to use this function.");
            return;
